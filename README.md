...
But on downloading the image from Site, the file names are prefixed with “300px”. Also we will do a sync on NetworkFAbricWiki which might bring new set of images. 
